...
import { LinkFeeBillingJobEditComponent } from './job-edit-link-fee.component';
//import { PlSheetPopupComponent } from './pl-sheet-popup/pl-sheet.popup';
import { SharedModule } from 'src/app/shared/shared.module';
import { JobEditLazyLoadComponentModule } from './job-edit-link-fee-lazy-load-component.module';
...
const routing: Routes = [
    {
        path: ":id", component: LinkFeeBillingJobEditComponent, data: { name: "", serviceId: ChargeConstants.CL_CODE }, canDeactivate: [DeactivateGuardService]
    },
...
@NgModule({
    ...
    exports: [],
    declarations: [
        LinkFeeBillingJobEditComponent,
